...
#undef PL_LOCAL_CONFIG_HAS_EVENTS_DISABLED               /* disable events */
#undef  PL_LOCAL_CONFIG_HAS_TIMER_DISABLED                /* disable own timer */
#undef  PL_LOCAL_CONFIG_HAS_KEYS_DISABLED                 /* disable key/push buttons */
#undef  PL_LOCAL_CONFIG_HAS_SHELL_DISABLED                /* disable shell */
#undef PL_LOCAL_CONFIG_HAS_TRIGGER_DISABLED              /* disable triggers */
#undef  PL_LOCAL_CONFIG_HAS_DEBOUNCE_DISABLED             /* disable debouncing */
#define PL_LOCAL_CONFIG_HAS_RTOS_DISABLED                 /* disable RTOS usage */
#define PL_LOCAL_CONFIG_HAS_USB_CDC_DISABLED              /* disable USB CDC */
#undef PL_LOCAL_CONFIG_HAS_SEGGER_RTT_DISABLED           /* disable Segger RTT */
