    ...
    switch(data->state) {
...
#if 1 /* call event if you want to be notified here */
      ...
      case DBNC_KEY_PRESSED:
        ...
        if (keys==data->scanValue) { /* still pressing the same keys */
          /*! See how it checks long or short press */
...
#if 1 /* call event here if you want to be notified when button is released */
          ...
          /*! Here it goes to the next state */
